...
Os dados necessários para a empresa são quando a pessoa entra no onibus são os seguintes:
...
var pagante= parseInt("Quantas pessoas pagaram passagem ?")) ;
...
console. log("Essas pessoas",  pagante, " são pagantes e", gratuidade, "são gratuidade");
